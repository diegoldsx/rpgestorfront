...
export const projects = [
	{
		...
		dueDate: formatDate(faker.date.future({ years: 1, refDate: new Date() })),
	...
	},
	{
		...
		title: 'RPGestor .',
		subtitle:
			'RPGestor  stands out as the fastest and extensive customizable admin dashboard template.',
		status: 'review',
		label: 'bug',
		priority: 'medium',
		description:
	...
	},
	{
		...
		subtitle:
			'Create a Brand logo design for a RPGestor Admin. Total 21/25 tasks logo design for completed.',
		status: 'completed',
		label: 'bug',
		priority: 'high',
		description:

...
import { ProvisionSchemaType, ProvisionSchema } from "@/schemas/finance/provision";

interface Props {
	onSubmit: SubmitHandler<ProvisionSchemaType>;
	data?: Partial<ProvisionSchemaType>;
}

export function ProvisionForm({ onSubmit, data }: Props) {
	const methods = useForm<ProvisionSchemaType>({

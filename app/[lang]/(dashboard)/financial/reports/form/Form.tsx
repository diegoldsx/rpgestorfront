...
import { ReportSchemaType, ReportSchema } from "@/schemas/finance/report";

interface Props {
	onSubmit: SubmitHandler<ReportSchemaType>;
	data?: Partial<ReportSchemaType>;
}

export function ReportsForm({ onSubmit, data }: Props) {
	const methods = useForm<ReportSchemaType>({

...
import { RemittanceSchemaType, RemittanceSchema } from "@/schemas/finance/remittance";

interface Props {
	onSubmit: SubmitHandler<RemittanceSchemaType>;
	data?: Partial<RemittanceSchemaType>;
}

export function RemittancesForm({ onSubmit, data }: Props) {
	const methods = useForm<RemittanceSchemaType>({

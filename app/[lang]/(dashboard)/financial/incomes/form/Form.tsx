...
import { IncomeSchemaType, IncomeSchema } from "@/schemas/finance/income";

interface Props {
	onSubmit: SubmitHandler<IncomeSchemaType>;
	data?: Partial<IncomeSchemaType>;
}

export function IncomeForm({ onSubmit, data }: Props) {
	const methods = useForm<IncomeSchemaType>({

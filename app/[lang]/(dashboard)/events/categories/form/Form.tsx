...
import { CategorySchemaType, CategorySchema } from "@/schemas/events/category";

interface Props {
	onSubmit: SubmitHandler<CategorySchemaType>;
	data?: Partial<CategorySchemaType>;
}

export function CategoryForm({ onSubmit, data }: Props) {

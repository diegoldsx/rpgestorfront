...
import RPGestor from '@/public/images/all-img/dashtail-screenshot.png';
		...
		<Tailwind>
			<Body>
				<Container className='mx-auto bg-white rounded'>
					...
					<Section className='mt-5'>
						<Row>
							<Column className='pl-5 w-1/2'>
								<Text className='text-xl font-medium text-slate-800 mt-6'>
									Welcome to
								</Text>
								<Text className='text-xl  font-semibold text-slate-900 -mt-3'>
									DashTail
								</Text>
								<Text className='text-sm text-slate-700'>
									Dive into customization and thrive. Your journey starts now.{' '}
								</Text>
							</Column>
					...
					<Section className=' mt-5'>
						<Row>
							<Column className='flex flex-col items-center p-5 mx-5 bg-slate-200   border border-slate-300 rounded-md'>
								...
								/>
								<Text className='text-lg font-medium text-slate-900 mb-0'>
									John Doe{' '}
								</Text>
								<Text className='text-sm  text-slate-700 mt-0'>
									johndoe@example.com{' '}
								</Text>
								<Button
									href='https://rpgestor.com.br/contact-us'
					...
					<Section className='mt-5'>
						<Text className='text-base font-medium text-slate-900 px-5'>
							One month of free plan included.😂
						</Text>
						<Text className='text-sm  text-slate-700 px-5'>
							The package comes with a one-month complimentary plan, enabling
							users to experience the service at no cost for the first month.
						...
						<Row>
							...
							<Column>
								...
								<Text className='text-sm  text-slate-700 -mt-2'>
									We offer 24/7 client support for your convenience, ensuring
									assistance is available whenever you need it, day or night.
								</Text>
							</Column>
						</Row>
					...
					<Section className='mt-5'>
						<Row>
							<Column>
								<Text className='text-xl font-medium text-slate-900 pl-5'>
									Blog Tutorials
								</Text>
							</Column>
					...
					<Section className='mt-5 text-center'>
						<Text className='text-sm text-slate-700'>
							3rd Floor, Road# 29, House# 395, New DOHS, <br /> Mohakhali, Dhaka
							- 1206, Bangladesh
						</Text>

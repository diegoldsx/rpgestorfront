						...
						<Section>
							<Row>
								<Column className='p-10 pb-5'>
									...
									/>
									<Text className='text-3xl text-center font-semibold text-default-900'>
										Hi Sakil Anwar,
									</Text>
									<Text className='text-base text-default-700 text-center'>
										Welcome to CodeShaper, where innovation meets precision.
										Crafting your digital future with elegant solutions. Let's
										shape your success together. Evolve, adapt, conquer.
									</Text>

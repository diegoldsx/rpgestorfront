						...
						<Section>
							<Row>
								...
								<Column className='flex justify-end items-center gap-4 py-4 pr-8'>
									<Link
										href='/'
										className='text-sm font-medium text-gray-500 mt-1.5'
									>
										Home
									</Link>
									<Link
							...
							<Row>
								<Column className='flex flex-col items-center relative before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-gray-900/60 before:z-10 py-10 pb-16'>
									...
									<Text className='relative z-30 text-center text-base text-white  px-10 my-0'>
										Codeshaper is a creative agency that helps people to bring
										their business online. we also offer various digital
										marketing, web design, and development services.
									</Text>
									<Button
										className='relative z-30 text-center border  text-white border-white font-medium py-2.5 px-8 mt-7 rounded-full'
										href='/'
									>
										CONTACT US
									</Button>
									...
									<Row>
										<Column className='text-center bg-slate-50 w-1/3'>
											...
											<Text className='text-sm text-gray-500 px-1'>
												Creating engaging websites to enhance online presence
												effectively.
											</Text>
										</Column>
								...
								<Column className='bg-gray-50 py-10 px-5'>
									<Row>
										...
										<Column className='w-1/2'>
											<Text className='text-xl uppercase font-bold text-gray-900 mt-0'>
												Discussion
											</Text>
											<Text className='text-sm texty-gray-500'>
												Codeshaper is a creative agency that helps people to
												bring their business online. we also offer web
												development services.
											</Text>
											<Button
												className=' border border-gray-900 font-medium py-2.5 px-8  rounded-full mt-2'
												href='/'
											>
												Read More
											</Button>
						...
						<Section>
							<Row>
								<Column className='bg-gray-50 text-gray-900 py-10 px-10 mt-4 flex flex-col items-center'>
									<Text className='text-2xl font-medium uppercase text-center '>
										Build your website
									</Text>
									<Text className='text-base text-center mt-0'>
										Codeshaper is a creative agency that helps people to bring
										their business online. we also offer various digital
										marketing, web design, and development services.
									</Text>
									<Button
										className=' border border-gray-900 text-gray-900 font-medium py-2.5 px-8  rounded-full mt-3'
										href='/'
									>
										Get Started
									</Button>
								...
								<Column className='bg-gray-900 text-white pt-12 px-10'>
									<Row>
										...
										<Column className='pl-2 w-1/3'>
											...
											<Link
												href='/'
												className='text-sm font-medium text-slate-400 mt-1.5 block'
											>
												Home
											</Link>
											<Link
									...
									<Row>
										<Column className='pt-10 pb-2'>
											<Text className='text-xs text-slate-300'>
												COPYRIGHT &copy; 2024 RPGestor All rights <br />{' '}
												Reserved
											</Text>
										</Column>
										<Column className='pt-10 pb-2'>

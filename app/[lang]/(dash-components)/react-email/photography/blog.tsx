			...
			<Tailwind>
				<Body style={main}>
					<Container style={container}>
						...
						<Section>
							<Row>
								<Column className='bg-gray-50 pb-5  px-10'>
									<Text className='text-sm text-center text-gray-900 '>
										Don't want to receive email?{' '}
										<Link href='/' className='font-medium text-violet-500'>
											Unsubscribe here
										</Link>
									</Text>
									<Text className='text-sm text-center text-gray-900 my-0'>
										COPYRIGHT &copy; 2024 RPGestor All rights Reserved
									</Text>
								</Column>
							</Row>
						</Section>

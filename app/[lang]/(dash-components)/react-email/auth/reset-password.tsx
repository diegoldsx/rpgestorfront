			...
			<Tailwind>
				<Body style={main}>
					<Container style={container}>
						...
						<Section>
							<Text className='mt-5 text-base font-medium text-slate-900 px-10'>
								Hi Sakil,
							</Text>
						...
						<Text className='px-10 text-sm text-gray-900 mt-5'>
							Sent with ❤️ from RPGestor{' '}
						</Text>
						<Text className='px-10 text-sm text-gray-900 -mt-2'>
							{' '}

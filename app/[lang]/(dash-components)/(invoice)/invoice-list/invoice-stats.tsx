// app/dashboard/invoice/invoice-stats/page.tsx
'use client';
			...
			{data.map((item, index) => (
				...
				>
					<div className='flex gap-2'>
						<div className='flex-1 text-sm font-medium text-default-800 dark:text-default-50'>
							{item.title}
						</div>
						<div
							className={cn(
					...
					<div className='flex gap-3'>
						<div className='flex-1'>
							<div className='mt-2'>
								...
								>
									<span className='text-sm font-medium absolute top-0 left-0'>
										$
									</span>
									<span className='text-2xl font-semibold pl-2.5'>
										{item.amount}k
									</span>
								</div>
							</div>

...
>(({ className, ...props }, ref) => (
	<th
		ref={ref}
		className={cn(
			"h-14 px-4  font-semibold  text-sm  text-default-800    capitalize  ltr:[&:has([role=checkbox])]:pr-0 rtl:[&:has([role=checkbox])]:pl-0",
			className
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<td
		ref={ref}
		className={cn(
			"p-4 align-middle  text-sm text-default-600  font-normal  ltr:[&:has([role=checkbox])]:pr-0 rtl:[&:has([role=checkbox])]:pl-0",
			className
		)}
		{...props}
	/>

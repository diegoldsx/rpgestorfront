...
const buttonVariants = cva(
	"inline-flex items-center justify-center rounded-sm text-sm font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-0   disabled:opacity-50  whitespace-nowrap disabled:pointer-events-none",
	{
		variants: {
			color: {
			...
			size: {
				...
				lg: "h-11 rounded-sm px-[18px] py-[10px] text-base",
				xl: "h-12 rounded-sm px-6 py-3 text-base",
				md: "h-9 rounded-sm px-4 py-2",
				xs: "h-9 rounded-sm px-[14px] py-[6px]",
				icon: "h-10 w-10",
			},
		},
		compoundVariants: [

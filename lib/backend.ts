...
export const db = {
  ...
  contents: createTable([
    {
      id: "content-1",
      contentType: { id: "ct-1", name: "Notícia" },
      status: "active",
      title: "Nova Notícia",
  ...
  emails: createTable([
    { id: "email-2", email: "email2@email.com", status: "inactive" },
  ]),
  ...
  eventCategories: createTable([
    { id: "ec-2", name: "Seminário", status: "inactive" },
  ]),
  ...
  provisions: createTable([
    { id: "provision-1", ammount: "1000", description: "Provisão", observations: "Observações" },
  ]),
  remittances: createTable([
    { id: "remittance-1", bank: "itau", search: "busca", searchFor: "busca por", dataType: "due", type: "all" },
  ]),
  returns: createTable([
    { id: "return-1", account: "bradesco", filePath: "caminho/arquivo" },
  ]),
  transfers: createTable([
    { id: "transfer-1", origin: "conta1", destination: "conta2", date: "2024-04-01", amount: "100" },
  ]),
  members: createTable([
    {
      id: "member-1",
  ...
  affiliationCategories: createTable([
    { id: 2, name: "Categoria B", status: "inactive" },
  ]),
  ...
  users: createTable([
    { id: "user-1", name: "Usuário A", email: "usuario@email.com", status: "active", username: "usuario1" },
  ]),
};
